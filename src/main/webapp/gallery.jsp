...
<html>
<head>
    <title>Gallery | YiFanZhou Apartment Demo | by Yifan Yizhou Ziwen</title>
    <!-- custom-theme -->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords" content="Yifanzhou 一帆舟 Auburn is the Best; Best Professor of the World: Marghitu & Fatemeh" />
    ...
    <link href="css/simpleLightbox.css" rel="stylesheet" type="text/css" /></head>
<body>
<!-- banner -->
<div class="header">
...
<div class="banner-bottom gallery">
    <div class="container">
        ...
        <div class="wthree-heading">
            ...
            <p class="quia">The Best Apartment in town by Yifan-the-Greatest Construction Group</p>
        </div>
        <div class="w3ls_gallery_grids">
            <div class="col-md-4 w3_agile_gallery_grid">
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g1.jpg">
                        <div class="agile_gallery_grid1">
                            <img src="images/g1.jpg" alt=" " class="img-responsive" />
                            <div class="w3layouts_gallery_grid1_pos">
                                <h4>YiFanZhou Student Apartment</h4>
                ...
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g2.jpg">
                        <div class="agile_gallery_grid1">
                ...
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g3.jpg">
                        <div class="agile_gallery_grid1">
            ...
            <div class="col-md-4 w3_agile_gallery_grid">
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g4.jpg">
                        <div class="agile_gallery_grid1">
                ...
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g5.jpg">
                        <div class="agile_gallery_grid1">
                ...
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g6.jpg">
                        <div class="agile_gallery_grid1">
            ...
            <div class="col-md-4 w3_agile_gallery_grid">
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g7.jpg">
                        <div class="agile_gallery_grid1">
                ...
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g8.jpg">
                        <div class="agile_gallery_grid1">
                ...
                <div class="agile_gallery_grid">
                    <a title="Auburn Housing" href="images/g9.jpg">
                        <div class="agile_gallery_grid1">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5>COMP 6000 Final Project Demo</h5>
                    <p>Thanks Professor Jamshidi!</p>
                </div>
            </div>
        </div>
    </div>
